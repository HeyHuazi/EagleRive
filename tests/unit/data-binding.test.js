...
describe('DataBinding module', () => {
  ...
  beforeEach(() => {
    ...
    const mockVMI = {
      ...
      properties: [
        { name: 'testTrigger', type: 7 }, // DataType.trigger = 7
        { name: 'testBool', type: 3 }, // DataType.boolean = 3
        { name: 'testNumber', type: 2 }, // DataType.number = 2
        { name: 'testString', type: 1 }, // DataType.string = 1
      ],
    };
    ...
    // Load data-binding module after DOM is setup
    loadModule('data-binding.js');
  });
  ...
  describe('renderVMProperties', () => {
    ...
    it('should render color properties', () => {
      // Add a color property (DataType.color = 4)
      mockRiveInstance.viewModelInstance.properties.push({ name: 'testColor', type: 4 });
    ...
    it('should render list properties', () => {
      // Add a list property (DataType.list = 5)
      mockRiveInstance.viewModelInstance.properties.push({ name: 'testList', type: 5 });
